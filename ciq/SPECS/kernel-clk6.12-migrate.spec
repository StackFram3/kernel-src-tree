...
Obsoletes: kernel-headers = %{old_ver1}
Obsoletes: kernel-headers = %{old_ver2}
Obsoletes: kernel-headers = %{old_ver3}
Obsoletes: kernel-headers = %{old_ver4}
...
Obsoletes: kernel-doc = %{old_ver1}
Obsoletes: kernel-doc = %{old_ver2}
Obsoletes: kernel-doc = %{old_ver3}
Obsoletes: kernel-doc = %{old_ver4}
...
Obsoletes: kernel-cross-headers = %{old_ver1}
Obsoletes: kernel-cross-headers = %{old_ver2}
Obsoletes: kernel-cross-headers = %{old_ver3}
Obsoletes: kernel-cross-headers = %{old_ver4}
...
Obsoletes: kernel-tools = %{old_ver1}
Obsoletes: kernel-tools = %{old_ver2}
Obsoletes: kernel-tools = %{old_ver3}
Obsoletes: kernel-tools = %{old_ver4}
...
Obsoletes: kernel-tools-libs = %{old_ver1}
Obsoletes: kernel-tools-libs = %{old_ver2}
Obsoletes: kernel-tools-libs = %{old_ver3}
Obsoletes: kernel-tools-libs = %{old_ver4}
...
Obsoletes: kernel-tools-libs-devel = %{old_ver1}
Obsoletes: kernel-tools-libs-devel = %{old_ver2}
Obsoletes: kernel-tools-libs-devel = %{old_ver3}
Obsoletes: kernel-tools-libs-devel = %{old_ver4}
...
Obsoletes: kernel-devel = %{old_ver1}
Obsoletes: kernel-devel = %{old_ver2}
Obsoletes: kernel-devel = %{old_ver3}
Obsoletes: kernel-devel = %{old_ver4}
...
Obsoletes: kernel-devel-matched = %{old_ver1}
Obsoletes: kernel-devel-matched = %{old_ver2}
Obsoletes: kernel-devel-matched = %{old_ver3}
Obsoletes: kernel-devel-matched = %{old_ver4}
...
Obsoletes: perf = %{old_ver1}
Obsoletes: perf = %{old_ver2}
Obsoletes: perf = %{old_ver3}
Obsoletes: perf = %{old_ver4}
...
Obsoletes: python3-perf = %{old_ver1}
Obsoletes: python3-perf = %{old_ver2}
Obsoletes: python3-perf = %{old_ver3}
Obsoletes: python3-perf = %{old_ver4}
...
Obsoletes: libperf = %{old_ver1}
Obsoletes: libperf = %{old_ver2}
Obsoletes: libperf = %{old_ver3}
Obsoletes: libperf = %{old_ver4}
...
Obsoletes: libperf-devel = %{old_ver1}
Obsoletes: libperf-devel = %{old_ver2}
Obsoletes: libperf-devel = %{old_ver3}
Obsoletes: libperf-devel = %{old_ver4}
...
Obsoletes: rtla = %{old_ver1}
Obsoletes: rtla = %{old_ver2}
Obsoletes: rtla = %{old_ver3}
Obsoletes: rtla = %{old_ver4}
...
Obsoletes: rv = %{old_ver1}
Obsoletes: rv = %{old_ver2}
Obsoletes: rv = %{old_ver3}
Obsoletes: rv = %{old_ver4}
...
Obsoletes: kernel-selftests-internal = %{old_ver1}
Obsoletes: kernel-selftests-internal = %{old_ver2}
Obsoletes: kernel-selftests-internal = %{old_ver3}
Obsoletes: kernel-selftests-internal = %{old_ver4}
...
Obsoletes: kernel-ipaclones-internal = %{old_ver1}
Obsoletes: kernel-ipaclones-internal = %{old_ver2}
Obsoletes: kernel-ipaclones-internal = %{old_ver3}
Obsoletes: kernel-ipaclones-internal = %{old_ver4}
...
Obsoletes: kernel-abi-stablelists = %{old_ver1}
Obsoletes: kernel-abi-stablelists = %{old_ver2}
Obsoletes: kernel-abi-stablelists = %{old_ver3}
Obsoletes: kernel-abi-stablelists = %{old_ver4}
...
Obsoletes: kernel-uki-virt-addons = %{old_ver1}
Obsoletes: kernel-uki-virt-addons = %{old_ver2}
Obsoletes: kernel-uki-virt-addons = %{old_ver3}
Obsoletes: kernel-uki-virt-addons = %{old_ver4}
